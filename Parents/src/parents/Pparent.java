 ...
 * @author user
 */
public class Pparent extends javax.swing.JFrame {
    Connection con =null;
    PreparedStatement pst=null;

    /**
     * Creates new form Pparent
     */
    public Pparent() {
        initComponents();
    }
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(layout.createSequentialGroup()
                                .addGap(204, 204, 204)
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addComponent(txtU, javax.swing.GroupLayout.PREFERRED_SIZE, 71, javax.swing.GroupLayout.PREFERRED_SIZE)
                                    .addComponent(passcode, javax.swing.GroupLayout.PREFERRED_SIZE, 146, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void submitActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_submitActionPerformed
        ...
        String url = "jdbc:mysql://localhost:3306/student information";
        try{
...
// TODO add your handling code here:
    ...
    private void deleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteActionPerformed
      ...
      String x = null;
        try{
            String query="DELETE FROM children WHERE FIRSTNAME =''";
            Class.forName("com.mysql.cj.jdbc.Driver");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Pparent.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
